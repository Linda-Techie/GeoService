...
public class GoogleRevGeo extends Geo {

	public GoogleRevGeo(String apiGeoUrl, String strLat, String strLng, String apiKey) throws Exception {
	...
	public static String getGeo(String url, String strLat, String strLng, String key) throws Exception {
		GoogleRevGeo geo = new GoogleRevGeo(url, strLat, strLng, key);
		geo.setLatLng();
	...
	public static void main(String[] args) {
	    ...
	    try {
	    	String rtn = GoogleRevGeo.getZip(args[0], args[1], args[2], args[3]);
